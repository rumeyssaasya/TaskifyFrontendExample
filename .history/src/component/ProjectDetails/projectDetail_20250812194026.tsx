...
import AddMember from "../AddMember/addMember"; // AddMember bileşeni eklendi
        ...
        <>
          <div className="project-header">
            ...
            <AddMember
              ...
              onMemberAdded={() => {
                // İstersen buraya ekip güncelleme kodu ekleyebilirsin
                // Örneğin ProjectDetail'ı veya ekip listesini yenilemek için trigger
              }}
            />
          )}
            className={`add-member-btn ${showCreateTaskForm ? ' close' : ''}`}
            ></button>
          </div>
