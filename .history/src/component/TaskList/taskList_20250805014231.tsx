...
const TaskList: React.FC<TaskListProps> = ({ project, tasks, fetchTasks }) => {
  ...
  useEffect(() => {
    // Sadece projectId null olan görevler (bağımsız görevler)
    const filtered = tasks.filter(task => task.project === null);
  ...
  return (
    <div className="task-list-container">
      <h2 className="task-list-title">Bağımsız Görevler</h2>
