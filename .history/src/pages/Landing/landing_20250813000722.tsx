    ...
    <div className="landing-wrapper">
      <header className="header">
        ...
        <nav>
          ...
          <button className="btn connection" onClick={() => navigate("/auth/register")}>
            <a
              href="mailto:taskifyRMR@gmail.com"onMouseEnter={e => (e.currentTarget.style.backgroundColor = "#0056b3")}
