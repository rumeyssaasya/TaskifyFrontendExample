...
const RegisterForm = () => {
  ...
  const isFormValid = email && fullName && gender && username && password && passwordsMatch;
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Remove token storage if you're doing email verification
        ...
        <form onSubmit={handleSubmit} className="register-form">
          ...
          {showEmailMessage && (
            <div className="email-message">
              <p>Mailinizi kontrol edin! Giriş sayfasına yönlendiriliyorsunuz...</p>
            </div>
          )}
        </form>
