...
import "./projects.css";
import type { Project,UserInfo } from "../../types"; // Proje tipi eklendi
...
const Projects: React.FC = () => {
  ...
  const [selectedProjectCollaborators, setSelectedProjectCollaborators] = useState<UserInfo[]>([]);
  ...
  // Seçili proje değiştiğinde collaborators’ı çek
  useEffect(() => {
    if (selectedProjectId !== null) {
      api.get<{ collaborators: UserInfo[] }>(`/projects/${selectedProjectId}/shared`)
        .then(res => {
          setSelectedProjectCollaborators(res.data.collaborators ?? []);
        })
        .catch(() => {
  ...
  console.log("selectedProjectCollaborators", selectedProjectCollaborators);
  /* --------- RENDER --------- */
 return (
  <div className="projects-page">
    ...
    <div className="main-wrapper"> {/* Sidebar + Content beraber */}
      ...
      <div className="projects-content">
        ...
        {selectedProjectCollaborators.length > 0 ? (
          <div className="collaborators">
            {selectedProjectCollaborators.map((c, idx) => (
              <div key={idx} className="avatar" title={c.fullName}>
