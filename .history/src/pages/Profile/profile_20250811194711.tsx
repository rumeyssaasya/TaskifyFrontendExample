...
function ProfilePage({
  ...
  const handleEditToggle = () => {
    ...
    setTempFullName(userInfo.fullName);
    setSelectedImage(userInfo.profileImageUrl ? `http://localhost:8080${userInfo.profileImageUrl}` : '');
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (tempFullName !== userInfo.fullName || updatedImageUrl !== userInfo.profileImageUrl) {
