...
function ProfilePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const normalizedOldUrl = profile.profileImageUrl?.startsWith('/') ? profile.profileImageUrl : '/' + profile.profileImageUrl;

      if (tempFullName !== profile.fullName || relativeImageUrl !== normalizedOldUrl) {
