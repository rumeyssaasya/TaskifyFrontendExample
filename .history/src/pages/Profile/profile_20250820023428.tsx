...
function ProfilePage() {
  ...
  const backendBaseUrl = "https://taskifybackendapi-production.up.railway.app/resources/static";
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        if (data.profileImageUrl && profileImageOptions.includes(data.profileImageUrl)) {
